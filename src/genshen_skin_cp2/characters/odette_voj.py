...
与 CP1 (Genshen-skin-CP2, 奥黛塔 × 沃雅妮莎) 的命名空间完全隔离:
...
# ---------------------------------------------------------------- 素材
IMAGE_FILES = ["01-odette.jpg", "02-mitiya.jpg", "03-heart.jpg"]
IMAGE_NAMES = ["相依", "星轨", "比心"]

# 每张素材的说明(画廊/README 用), 键为 IMAGE_FILES 中的文件名
IMAGE_META = {
    "01-odette.jpg": {
        "title": "相依",
        "desc": "白发紫瞳的奥黛塔与深蓝长发的沃雅妮莎相偎, 浅蓝礼服与星星装饰",
        # 桌宠取景: (中心x比例, 中心y比例, 半边长占最短边比例)
        "pet_crop": (0.50, 0.44, 0.46),
        # 满屏模式的取景偏向: 这张是 0.75 的竖图, 正中对半切会裁掉两人的头,
        # 因此把取景窗上移, 优先保住脸和头发。
        "cover_bias": (0.50, 0.28),
    },
    "02-mitiya.jpg": {
        "title": "星轨",
        "desc": "蓝白礼服与金色星轨饰链, 白日波点背景",
        "pet_crop": (0.50, 0.50, 0.46),
        "cover_bias": (0.50, 0.42),
    },
    "03-heart.jpg": {
        "title": "比心",
        "desc": "夜色中共执双手比出心形, 音符与星光环绕",
...
DEEPKING_SKIN_DESC = (
    "奥黛塔与沃雅妮莎的浅蓝同人主题: 主色取自「相依」插画的星蓝与薰衣草紫, "
    "亮色为白日浅蓝, 夜景为深海底色。32 槽位逐项校色。"
)
